...
import com.suyuan.common.annotation.Log;
import com.suyuan.common.model.R;
import com.suyuan.common.model.PageModel;
import com.suyuan.common.model.PageResult;
...
import ${package.Controller?replace("controller","dtomapper")}.M${entity}MapperImpl;
...
public class ${table.controllerName} {
    ...
    private final M${entity}MapperImpl m${entity}Mapper;
    ...
    public R<PageResult<${entity}ListOutputDTO>> pageList(${entity}SearchInputDTO ${entity?uncap_first}SearchInputDTO, PageModel pageModel) {
        ...
        // 转换新对象
        List<${entity}ListOutputDTO> ${entity?uncap_first}ListOutputDTOS = m${entity}Mapper.toList(pageListByListInputDTO.getRecords());
        // 返回业务分页数据
