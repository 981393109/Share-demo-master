...
import com.correction.framework.security.core.handler.AccessDeniedHandlerImpl;
import com.correction.framework.security.core.handler.AuthenticationEntryPointImpl;
import com.correction.framework.security.core.handler.LogoutSuccessHandlerImpl;
 ...
 *
 * 注意，不能和 {@link } 用一个，原因是会导致初始化报错。
 * 参见 https://stackoverflow.com/questions/53847050/spring-boot-delegatebuilder-cannot-be-null-on-autowiring-authenticationmanager 文档。
 *
 */
@Configuration
@EnableConfigurationProperties(SecurityProperties.class)
public class YaoSecurityAutoConfiguration {
