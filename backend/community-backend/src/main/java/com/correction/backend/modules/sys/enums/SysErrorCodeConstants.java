...
import com.correction.framework.common.exception.ErrorCode;
...
public interface SysErrorCodeConstants {
    ...
    ErrorCode USER_ORG_IS_NOT_EXSIT = new ErrorCode(1002004006, "当前未选择所属机构");
    ErrorCode USER_ROLE_IS_NOT_EXSIT = new ErrorCode(1002004007, "当前未选择所属角色");
    ...
    // ========== 组织模块 1002014000 ==========
    ErrorCode ORG_NAME_DUPLICATE = new ErrorCode(1002014000, "已经存在该名字的组织");
    ErrorCode ORG_PARENT_NOT_EXITS = new ErrorCode(1002014001,"父级组织不存在");
    ErrorCode ORG_PARENT_ID_NULL = new ErrorCode(1002014002,"父级组织id为空");
    ErrorCode ORG_NOT_FOUND = new ErrorCode(1002014003, "当前组织不存在");
    ErrorCode ORG_EXITS_CHILDREN = new ErrorCode(1002014004, "存在子组织，无法删除");
    ErrorCode ORG_PARENT_ERROR = new ErrorCode(1002014005, "不能设置自己为父组织");
