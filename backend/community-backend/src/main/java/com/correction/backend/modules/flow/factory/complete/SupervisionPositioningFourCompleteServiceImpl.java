...
@Component
public class SupervisionPositioningFourCompleteServiceImpl implements FlowComplete{
    ...
    public void afterPropertiesSet() throws Exception {
        // 注册到Map中
        FlowCompleteFactory.register(FlowConstant.SUPERVISION_POSITION_FLOW_FOUR, this);
    }
