...
@Getter
@Setter
@ApiModel(value="SupervisionPositioningDevicesListOutputDTO", description="电子定位装置审批列表")
public class SupervisionPositioningDevicesListOutputDTO implements Serializable {
