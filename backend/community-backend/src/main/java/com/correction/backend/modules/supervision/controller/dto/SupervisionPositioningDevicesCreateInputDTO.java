...
@Getter
@Setter
@ApiModel(value="SupervisionPositioningDevicesCreateInputDTO", description="电子定位装置审批创建表单")
public class SupervisionPositioningDevicesCreateInputDTO implements Serializable {
