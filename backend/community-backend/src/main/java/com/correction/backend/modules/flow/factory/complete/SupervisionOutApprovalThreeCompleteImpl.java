...
@Component
public class SupervisionOutApprovalThreeCompleteImpl implements FlowComplete{
    ...
    public void afterPropertiesSet() throws Exception {
        // 注册到Map中
        FlowCompleteFactory.register(FlowConstant.SUPERVISION_OUT_THREE_COMPLETE_FLOW, this);
    }
}
