...
@Component
public class SupervisionPositioningThreeCompleteServiceImpl implements FlowComplete{
    ...
    public void afterPropertiesSet() throws Exception {
        // 注册到Map中
        FlowCompleteFactory.register(FlowConstant.SUPERVISION_POSITION_FLOW_THREE, this);
    }
