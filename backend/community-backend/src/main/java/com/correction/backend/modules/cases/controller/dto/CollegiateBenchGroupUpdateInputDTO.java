...
@Getter
@Setter
@ApiModel(value="CollegiateBenchGroupUpdateInputDTO", description="合议小组/评议小组/相关小组表修改表单")
public class CollegiateBenchGroupUpdateInputDTO implements Serializable {
