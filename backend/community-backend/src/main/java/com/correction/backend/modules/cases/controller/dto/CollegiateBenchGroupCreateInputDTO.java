...
@Getter
@Setter
@ApiModel(value="CollegiateBenchGroupCreateInputDTO", description="合议小组/评议小组/相关小组表创建表单")
public class CollegiateBenchGroupCreateInputDTO implements Serializable {
