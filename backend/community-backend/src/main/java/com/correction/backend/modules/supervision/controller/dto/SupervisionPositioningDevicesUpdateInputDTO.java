...
@Getter
@Setter
@ApiModel(value="SupervisionPositioningDevicesUpdateInputDTO", description="电子定位装置审批修改表单")
public class SupervisionPositioningDevicesUpdateInputDTO implements Serializable {
