...
@Component
public class RewardRecordOneFlowCompleteImpl implements FlowComplete{
    ...
    public void doUpdateData(String dataId, String ref, String progress, String status) {
        ...
        if(WorkFlowConstant.TASK_SUCCESS.equals(status)){
            ...
            if(StringUtils.isNotBlank(progress)){
                if(5 == Integer.parseInt(progress)) {
                    byId.setProgress(7);
                    byId.setApplyStatus(7);
                } else if (10 == Integer.parseInt(progress)){
                    byId.setProgress(12);
                    byId.setApplyStatus(12);
                } else {
