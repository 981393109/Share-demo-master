...
@Component
public class SupervisionOutApprovalTwoCompleteImpl implements FlowComplete{
    ...
    public void afterPropertiesSet() throws Exception {
        // 注册到Map中
        FlowCompleteFactory.register(FlowConstant.SUPERVISION_OUT_TWO_COMPLETE_FLOW, this);
    }
}
